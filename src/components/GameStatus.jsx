...
const GameStatus = ({ gamePhase, currentRound }) => {
  // Hide during interlude
  if (gamePhase === 'interlude') return null;
    ...
    <div className="absolute top-4 left-4">
      <div className="bg-gray-900 bg-opacity-80 px-4 py-2 rounded-lg backdrop-blur-sm">
        <p className="text-cyan-400 text-sm font-mono">
          ...
          {gamePhase === 'questioning' && `ROUND ${currentRound} - ANSWERING QUESTIONS`}
